...
class Closed implements State {
  ...
  open(): void {
    console.log("%cbriendo la puerta...", COLORS.green);
...
class Opening implements State {
  ...
  private async afterOpen() {
    ...
    console.log("%cLa puerta se ha abierto.", COLORS.green);
    this.door.setState(new Open(this.door));
  }

  open(): void {
    console.log("%cLa puerta ya se está abriendo.", COLORS.yellow);
  }
...
class Open implements State {
  ...
  close(): void {
    console.log("%cCerrando la puerta...", COLORS.green);
...
class Closing implements State {
  ...
  open(): void {
    console.log(
      "%cDetectando movimiento. Abriendo la puerta nuevamente...",
      COLORS.green
    );
    this.door.setState(new Opening(this.door));
  }
  ...
  private async afterClosed() {
    ...
    console.log("%cLa puerta se ha cerrado.", COLORS.green);
