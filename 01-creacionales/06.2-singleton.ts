...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    if (!DatabaseConnection.instance) {
      ...
      console.log("%cNueva conexión a la base de datos creada!", COLORS.green);
    }
  ...
  public connect(): void {
    ...
    if (!this.connected) {
      this.connected = true;
      console.log("%cConectado a la base de datos.", COLORS.cyan);
    } else {
      console.log(
        "%cYa existe una conexión activa a la base de datos.",
        COLORS.yellow
      );
    }
  }
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      ...
      console.log(
        "%cNo hay una conexión activa para desconectar.",
        COLORS.yellow
      );
    }
  }
