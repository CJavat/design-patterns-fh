...
class MenuCategory implements MenuComponent {
  //* Crear dos propiedades privadas: name y items
  ...
  //* Sobrecarga de operadores - Item puede ser MenuComponent o un arreglo de MenuComponent
...
//* en esta función main, no deben de hacer nada, al ejecutarla,
