...
abstract class Notification {
  //* Definir la propiedad `channel` de tipo NotificationChannel
  ...
  //* Definir el método `notify` y `setChannel` (abstractos)
...
function main() {
  ...
  alert.notify("¡Esta es una alerta importante!");

  // Agregar un nuevo canal en tiempo de ejecución
  alert.addChannel(new PushNotificationChannel());
  alert.notify("¡Esta es otra alerta importante!");
